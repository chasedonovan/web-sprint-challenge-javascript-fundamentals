...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// -closure is a way to understand how different functions can see outside of themselves and into the global scope. "its like a one way mirror"
...
function lowPopulationAnimals(data){
    let arr = data.filter(i=> i["population"] < 5)
    return arr;
  }
...
const cuboidTwo = new CuboidMakerTwo({length: 4, width: 4, length: 4});
